class Mailer{
    ...
    static NovaConta(user, link){
        ...
        mail += `           <span style="color:white;font-size:1.5em"> <b>Lead</b>This - Catalog </span>`;
        mail += `       </div>`;
        ...
        mail += `               <h2 style="border:none;margin:0px;padding:0px;text-decoration:none;color:rgb(0, 0, 0);font-size:1.5em;font-weight:bold;line-height:45px;letter-spacing:-0.04em;text-align:center;">Bem vindo, ${user.name}!</h2>`;
        mail += `               <p style="font-size: 1.5em;"> Agora, você só precisa definir a sua senha neste link: <a href="${link}">Clique aqui</a> </p>`;
        mail += `           </div>`;
        mail += `           <div style="max-width:100%; min-height: 30px; background-color: #F7F7F7; padding: 5px 0 5px 20px">`;
        mail += `               <p style="color: #88898C; font-size: 1em;"><b>Lead</b>This - Catalog</p>`;
        mail += `               <p><small style="color: #ddd;">by Lumine - 2020</small></p>`;
        mail += `           </div>`;
        mail += `       </div>`;
        mail += `   </body>`;
        mail += `</html>`;
